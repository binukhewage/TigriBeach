...
export default function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "We are open daily from 09:30 AM to 11:00 PM (Sri Lanka Time / GMT+5:30). We serve breakfast, lunch, sunset snacks, dinner, and late-night drinks.",
    },
    {
      question: "Do you offer fresh seafood daily?",
      answer: "Yes, 100%! We source all our seafood—including lobster, lagoon crabs, jumbo tiger prawns, calamari, and reef fish—every single morning directly from local Hikkaduwa fishermen at the harbor.",
    },
    {
      question: "Do you have vegetarian, vegan, or gluten-free options?",
      answer: "Absolutely. Along with our seafood focus, we prepare traditional Sri Lankan vegetarian curries (such as dhal, beetroot, and jackfruit curries), fresh tropical fruit salads, and customized dishes. Please inform your server of any dietary needs.",
    },
    {
      question: "Is there parking available near the restaurant?",
      answer: "Yes, roadside parking is available on Galle Road directly outside the restaurant. Additionally, we have beach-level bicycle and scooter parking space.",
    },
    {
      question: "How do I book a beach table for sunset?",
      answer: "Sunset tables are highly sought after (sunset is typically between 06:00 PM and 06:30 PM). You can submit a request using our online booking form above or call us directly at +94 77 104 8202 to confirm your table placement.",
    },
  ];
