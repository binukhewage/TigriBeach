...
export default function Reviews() {
  const reviews = [
    ...
    {
      author: "Erky B",
      source: "TripAdvisor • London, UK",
      rating: 5,
      text: "Superb seafood at a fraction of the price. The mixed seafood grill was outstanding, the friendly host made us feel welcome, and the unobstructed beachfront views made sunset dinner unforgettable.",
      date: "December 2024",
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "Among the best seafood I've had anywhere, not just Sri Lanka. The seafood platter with lobster, prawns, crab, and squid in a Thai-style lime sauce was exceptional, complemented by friendly service and great music.",
      date: "April 2022",
    },
    {
      author: "David Miller",
    ...
    {
      author: "Prdh1968",
      source: "TripAdvisor • Barcelona, Spain",
      rating: 5,
      text: "Amazing fresh seafood, stunning sea views, and excellent service. Owner Nishan was incredibly helpful, and the food was some of the best we enjoyed in Sri Lanka at very reasonable prices.",
      date: "March 2022",
    },
    {
      author: "Harry S",
      source: "TripAdvisor Traveler",
      rating: 5,
      text: "A hidden gem with fantastic seafood. The platter featuring fish, crab, and prawns was beautifully cooked, the vegetables were perfectly seasoned, and the staff made great recommendations.",
      date: "August 2023",
    },
    {
      author: "Veronica C",
      source: "TripAdvisor • Como, Italy",
      rating: 5,
      text: "A romantic seaside dinner with delicious fresh fish, kind and attentive service, and a welcoming family-run atmosphere. Excellent value for money and highly recommended for couples and families alike.",
      date: "November 2024",
    },
  ];
